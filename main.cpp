...
int main()
{
    ...
    output.open("D://Qt/WithoutPCAP/out.txt", ios::out );
    if (!output.is_open()) return -1;
    file.open("D://Qt/WithoutPCAP/my.pcap", ios::binary|ios::in);
    ...
    fstream file_bubble;
    file_bubble.open("D://Qt/WithoutPCAP/bubble.txt", ios::out );
    ...
    fstream file_merge;
    file_merge.open("D://Qt/WithoutPCAP/merge.txt", ios::out );
